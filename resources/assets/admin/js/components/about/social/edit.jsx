...
const Edit = ({current, fetching, fetchItemAndSetCurrent, updateItemAndSetCurrent, clearCurrentItem}) => {
    ...
    return (
        <div className="edit-page about-socials">
            {fetching && <LoadingGeneric />}
            <div className="row mb-3">
                <div className="col">
                    <div className="h3 title">
                        Редактировать иконки социальных сетей попап about
                    </div>
                </div>
            </div>
            <GenericForm
...
export default connect(
    state => ({
        current: state.about.social.current,
        fetching: state.about.social.fetching
