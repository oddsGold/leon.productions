...
const Edit = ({current, fetching, fetchItemAndSetCurrent, updateItemAndSetCurrent, clearCurrentItem}) => {
    ...
    return (
        <div className="edit-page about-description">
            {fetching && <LoadingGeneric />}
            <div className="row mb-3">
                <div className="col">
                    <div className="h3 title">
                        Редактировать описание попап about
                    </div>
                </div>
            </div>
            <GenericForm
...
export default connect(
    state => ({
        current: state.about.description.current,
        fetching: state.about.description.fetching
