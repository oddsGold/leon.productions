...
const Edit = ({current, fetching, fetchItemAndSetCurrent, updateItemAndSetCurrent, clearCurrentItem}) => {
    ...
    return (
        <div className="edit-page contact-contacts">
            {fetching && <LoadingGeneric />}
            <div className="row mb-3">
                <div className="col">
                    <div className="h3 title">
                        Редактировать контакты попап contact
                    </div>
                </div>
            </div>
            <GenericForm
...
export default connect(
    state => ({
        current: state.contact.contact.current,
        fetching: state.contact.contact.fetching
