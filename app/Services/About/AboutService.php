...
class AboutService
{
    ...
    public function getSocialMediaForSite()
    {
        return array_values(
            array_map(function($social){
                ...
                [
                    'link' => $this->dictionaryService->get('about_social_instagram_link', null),
                    'icon' => $this->dictionaryService->get('social_instagram_icon', null),
                    'published' => $this->dictionaryService->get('about_social_instagram_published', false),
                ],
                [
                    'link' => $this->dictionaryService->get('about_social_facebook_link', null),
                    'icon' => $this->dictionaryService->get('social_facebook_icon', null),
                    'published' => $this->dictionaryService->get('about_social_facebook_published', false),
                ],
                [
                    'link' => $this->dictionaryService->get('about_social_youtube_link', null),
                    'icon' => $this->dictionaryService->get('social_youtube_icon', null),
                    'published' => $this->dictionaryService->get('about_social_youtube_published', false),
                ],
                [
                    'link' => $this->dictionaryService->get('about_social_linkedin_link', null),
    ...
    {
        return [
            'instagram_link' => (string)$this->dictionaryService->get('about_social_instagram_link', null),
            'instagram_published' => $this->dictionaryService->get('about_social_instagram_published', null),
            'facebook_link' => (string)$this->dictionaryService->get('about_social_facebook_link', null),
            'facebook_published' => $this->dictionaryService->get('about_social_facebook_published', null),
            'youtube_link' => (string)$this->dictionaryService->get('about_social_youtube_link', null),
            'youtube_published' => $this->dictionaryService->get('about_social_youtube_published', null),
            'linkedin_link' => (string)$this->dictionaryService->get('about_social_linkedin_link', null),
            'linkedin_published' => $this->dictionaryService->get('about_social_linkedin_published', null),
            'vimeo_link' => (string)$this->dictionaryService->get('about_social_vimeo_link', null),
    ...
    {
        return [
            'instagram_link' => (string)$this->dictionaryService->set('about_social_instagram_link', $data['instagram_link']),
            'instagram_published' => $this->dictionaryService->set('about_social_instagram_published', $data['instagram_published']),
            'facebook_link' => (string)$this->dictionaryService->set('about_social_facebook_link', $data['facebook_link']),
            'facebook_published' => $this->dictionaryService->set('about_social_facebook_published', $data['facebook_published']),
            'youtube_link' => (string)$this->dictionaryService->set('about_social_youtube_link', $data['youtube_link']),
            'youtube_published' => $this->dictionaryService->set('about_social_youtube_published', $data['youtube_published']),
            'linkedin_link' => (string)$this->dictionaryService->set('about_social_linkedin_link', $data['linkedin_link']),
            'linkedin_published' => $this->dictionaryService->set('about_social_linkedin_published', $data['linkedin_published']),
            'vimeo_link' => (string)$this->dictionaryService->set('about_social_vimeo_link', $data['vimeo_link']),
